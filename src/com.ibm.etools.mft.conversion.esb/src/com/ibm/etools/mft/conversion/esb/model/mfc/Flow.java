 ...
 *         &lt;element ref="{http://www.ibm.com/xmlns/prod/websphere/2010/MediationFlow}node" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "flow", propOrder = { "note", "abstractProperty", "node", "extension" })
@XmlSeeAlso({ Subflow.class, OperationFlow.class })
public class Flow {
